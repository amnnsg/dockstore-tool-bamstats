...
cwlVersion: v1.0
doc: |
    ![build_status](https://quay.io/repository/amnnsg/dockstore-tool-bamstats/status)
    A Docker container for the BAMStats command. See the [BAMStats](http://bamstats.sourceforge.net/) website for more information.

dct:creator:
  "@id": "http://orcid.org/0000-0002-7681-6415"
  foaf:name: amnnsg, original Brian O'Connor
  foaf:mbox: "_____@gmail.com"

requirements:
  - class: DockerRequirement
    dockerPull: "quay.io/amnnsg/dockstore-tool-bamstats:1.25-4"
